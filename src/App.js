  ...
  const cities = [
    {
      ...
      description: "Lorem ipsum dolor sit amet consectetr adipisicing elit. Quis, facere ullam blanditiis vitae quo pariatur debitis illum necessitatibus esse officiis ab nisi suscipit et, molestias distinctio. Tempore, consectetur non sapiente repudiandae provident ipsam magnam odit molestiae ducimus sed ese, incidunt temporibus inventore aperiam dignissimos quidem fugiat laboriosam, possimus fuga doloribus!"
    },
    {
      cityName: "bangkok",
      population: "8M",
          ...
          <Route path="/"
            element={
              <div className='cities-container'>
                {
                  cities.map(city => {
                    return <CityCard city={city} user={user} />
                  })
                }
              </div>
            }
